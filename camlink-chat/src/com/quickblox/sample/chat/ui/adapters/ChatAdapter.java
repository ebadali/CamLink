...
public class ChatAdapter extends BaseAdapter {
    ...
    public ChatAdapter(Activity context, List<QBChatMessage> chatMessages) {
        ...
        map = ChatService.getInstance().getDialogsUsers();

        attachDrawable = context.getResources().getDrawable(R.drawable.attach);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(chatMessage.getAttachments() != null && chatMessage.getAttachments().size() > 0 && holder.attachment!=null) {
            holder.attachment.setBackground(attachDrawable);
        }



        String username = "";
        if(map.get(chatMessage.getSenderId()) != null)
        {
            username = map.get(chatMessage.getSenderId()).getLogin();
        }
        String status =  chatMessage.getProperty("status") != null ? "online" : "offline" ;
        if (chatMessage.getSenderId() != null) {
            holder.txtInfo.setText(username +" :  " +status +" : " + getTimeText(chatMessage));
        } else {
    ...
    public QBChatMessage remove(int index)
    { return chatMessages.remove(index); }
    ...
    private ViewHolder createViewHolder(View v) {
        ...
        holder.attachment = (ImageView) v.findViewById(R.id.sticker_image);
        return holder;
    }
