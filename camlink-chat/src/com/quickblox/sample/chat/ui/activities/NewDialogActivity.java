        ...
        createChatButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (usersAdapter.getSelected().size() == 1) {
                    SendChatActivitationDetails(QBDialogType.PRIVATE,usersListToChatName());
//                    dialogToCreate.setType(QBDialogType.PRIVATE);
                    ...
                    View view = inflater.inflate(R.layout.groupname_dialog, null);
                    alertDialogBuilder.setView(view);



                    final FormEditText textViewUser = (FormEditText) view.findViewById(R.id.group_text);

                    Button btn = (Button) view.findViewById(R.id.group_btn);
                    btn.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            if(textViewUser.testValidity()) {
                                SendChatActivitationDetails(QBDialogType.GROUP,
                                        new String(textViewUser.getText().toString()));
                                //finish();
                            }
                        }
                    });
...
//                            Toast.makeText(NewDialogActivity.this,"You clicked yes button", Toast.LENGTH_LONG).show();
//
//                            SendChatActivitationDetails(QBDialogType.GROUP,usersListToChatName());
//                            finish();
//                        }
//                    });
...
//
////                    dialog.setContentView(R.layout.groupname_dialog);
////                    dialog.setTitle("Group Name Required");
//
//
//                    final FormEditText textViewUser = (FormEditText) view.findViewById(R.id.group_text);
//
...
//
//                                    if(textViewUser.testValidity()) {
//                                        dialogToCreate.setName(new String(textViewUser.getText().toString()));
//                                        dialog.dismiss();
//                                    }
//
//                                }
...
//                    dialog.show();
////                    final FormEditText textViewUser = (FormEditText) dialog.findViewById(R.id.group_text);
////
////                    Button btn = (Button) dialog.findViewById(R.id.group_btn);
////                    btn.setOnClickListener(new View.OnClickListener() {
////                        @Override
////                        public void onClick(View v) {
////
...
//                if( dialogToCreate.getType()== QBDialogType.GROUP)
//                {
//                    if( dialogToCreate.getName() == null || dialogToCreate.getName().isEmpty() )
//                    {
//                        return;
//                    }
//                }
    ...
    public void SendChatActivitationDetails(QBDialogType someType, String ConvoName)
    {
        final QBDialog dialogToCreate = new QBDialog();
        dialogToCreate.setName(ConvoName);
        dialogToCreate.setType(someType);
    ...
    public static QBPagedRequestBuilder getQBPagedRequestBuilder(int page,int pagesize) {
        QBPagedRequestBuilder pagedRequestBuilder = new QBPagedRequestBuilder();

        pagedRequestBuilder.setPage(page);
        pagedRequestBuilder.setPerPage(pagesize);
    ...
    private void loadNextPage() {
        ...
        QBUsers.getUsers(getQBPagedRequestBuilder(currentPage,PAGE_SIZE), this);
    }
