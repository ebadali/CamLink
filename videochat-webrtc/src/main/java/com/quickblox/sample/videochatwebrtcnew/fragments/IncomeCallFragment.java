...
public class IncomeCallFragment extends Fragment implements Serializable {
    ...
    private void initUI(View view) {
        ...
        callerName.setText(OpponentsActivity.getUserName(SessionManager.getCurrentSession().getCallerID()));
        ...
        otherIncUsers.setText(OpponentsActivity.getUserName(opponents));//getOtherIncUsersNames(opponents));
