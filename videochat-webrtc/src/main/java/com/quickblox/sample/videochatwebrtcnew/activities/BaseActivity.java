...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setIcon(R.drawable.camlink);
        getSupportActionBar().setTitle("CamLink");
    }
    ...
    public void initActionBar() {
        if (loginedUser != null) {
            ...
            userNameAB.setText(loginedUser.getLogin());//DataHolder.getUserNameByID(loginedUser.getId()));
    ...
    protected void sendNotificationConnectionLost() {
        ...
        notificationBuilder.setSmallIcon(R.drawable.camlink)
    ...
    protected void minimizeApp(){
        ...
        newIntent.putExtra("data", "Some New Data");
