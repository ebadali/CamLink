...
public class OpponentsActivity extends BaseActivity implements View.OnClickListener {
    ...
    private int PAGECOUNT = 1, PERPAGE = 100;
    ...
    static List<QBUser> currUserList;
    ...
    private void initOpponentListAdapter() {
        ...
        QBPagedRequestBuilder requestBuilder = new QBPagedRequestBuilder(PERPAGE, PAGECOUNT);
...
//        }
    ...
    private void initUI() {
        ...
        opponentsListView.setChoiceMode(ListView.CHOICE_MODE_MULTIPLE);
    }
    ...
    public void onClick(View v) {
        ...
        } else if (opponentsAdapter.getSelected().size() > 0) {
    ...
    public static String getUserName(Integer integer) {
        //Log.i(TAG, "getUserName : -- "+integer);
        for (int i = 0; i < currUserList.size(); i++) {
            //Log.i(TAG, "getUserName : "+currUserList.get(i).getId());
            if (currUserList.get(i).getId().intValue() == integer.intValue())
                return currUserList.get(i).getLogin();
        }
        return "";
    }

    public static String getUserName(List<Integer> integer) {
        //Log.i(TAG, "getUserName : -- "+integer);
        String str = "";
        for (int i = 0; i < currUserList.size(); i++) {
            //Log.i(TAG, "getUserName : "+currUserList.get(i).getId());
            for (int j = 0; j < integer.size(); j++) {
                if (currUserList.get(i).getId().intValue() == integer.get(j).intValue())
                    str += currUserList.get(i).getLogin() + ",";
            }
        }
